...
const CACHE = `oncoconnect-${APP}-vdd7dd69222`;
const SHELL = APP === 'doctor'
  ? ['/dist/app.dd7dd69222.js', '/', '/index.html', '/sync-client.js', '/doctor.webmanifest', '/icons/doctor-192.png', '/icons/doctor-512.png']
  : ['/dist/app.dd7dd69222.js', '/patient.html', '/sync-client.js', '/vendor/qrcode.min.js', '/patient.webmanifest', '/icons/patient-192.png', '/icons/patient-512.png'];
